...
Public Class Viewroomsinfo
    Dim viewrooms As New roomsSql()
    Private originalroomnumber As String


    Private Sub Viewroomsinfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        populaterooms()
    End Sub
    Private Sub populaterooms()

        Dim query As String = "SELECT * FROM rooms"
        viewrooms.ExecuteQuery(query, DGV_Rooms)
    ...
    Private Sub FilterroomsByKeyword(keyword As String)
        ...
        viewrooms.SearchRooms(query, keyword, DGV_Rooms)
    End Sub
    ...
    Private Sub updateroom_btn_Click(sender As Object, e As EventArgs) Handles updateroom_btn.Click
        ...
        If roomnumber <> CInt(originalroomnumber) Then
            If viewrooms.RoomExists(roomnumber) Then
                isValid = False
        ...
        Try
            viewrooms.ExecuteNonQueryWithParameters(query, parameters)
